...
- Performance budgets enforced in CI using Lighthouse
- [Perfect 100 score](https://pagespeed.web.dev/analysis/https-asnine-me/oxos3o0aqy?form_factor=mobile) on Google's PageSpeed Insights for mobile (0.8s LCP) and desktop (0.2 LCP)
