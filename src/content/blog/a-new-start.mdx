...
> love is a key factor, but the extent as to which you are willing to challenge yourself is the be-all and end-all, **but that's a discussion for another time**.
