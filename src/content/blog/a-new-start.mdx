...
If you cannot answer both questions with a resounding **"yes"**, chances are you will probably shelve it at some point, adding it to the _not-completed-projects_ list.

But by having that key underlying love, it will act as a key motivator towards the completion of your future projects. In addition, no love comes without it's justifications, where you will be able to convey yourself with confidence. **_It's just a win-win tbh_**.
