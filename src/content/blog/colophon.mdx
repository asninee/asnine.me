...
- **Performance**. The above measures should help to guarantee quick site loading times, but there should be a habit of continally pursuing optimisations and applying them ([`100/100`](https://pagespeed.web.dev/analysis/https-asnine-me/j2ofvdcfno?form_factor=mobile) on Google's PageSpeed Insights).
- **Simplicity**. This should be applied in as many aspects as possible _e.g._ aesthetic, file structure, used technologies to name a few. Everything should have it's own specific purpose, with any unnecessary bloat being removed.
