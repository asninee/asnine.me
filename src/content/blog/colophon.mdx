...
- Minimising the site's network payload as much as possible (`52kb` bundle size, [99% cleaner](https://www.websitecarbon.com/website/asnine-me) than all web pages globally).
