...
- Minimising the site's network payload and enforcing performance budgets in CI.
...
- Avoiding custom web-font downloads and optimising local images as `.webp`.

Additional focuses include:

- Performance: continually pursuing measurable optimisations ([`100/100`](https://pagespeed.web.dev/analysis/https-asnine-me/oxos3o0aqy?form_factor=mobile) on PageSpeed Insights) and enforcing Lighthouse thresholds in CI.
...
- The syntax highlighting for code blocks is powered by [Prism](https://prismjs.com).
