...
updated: 2024-08-25
desc: 'motivations and technology choices.'
---
...
- Minimising the site's network payload as much as possible (`15kb` bundle size, [100% cleaner](https://www.websitecarbon.com/website/asnine-me) than all web pages globally).
...
- Performance: the above measures should help to guarantee quick site loading times, but there should be a habit of continally pursuing optimisations and applying them ([`100/100`](https://pagespeed.web.dev/analysis/https-asnine-me/44wlnjgnzj?form_factor=mobile) on Google's PageSpeed Insights).
...
This site heavily features the [Opening Hours Sans](https://github.com/opening-hours-studio/opening-hours-sans) typeface, where it satiated my hunt for a [Helvetica Neue](https://www.myfonts.com/collections/neue-helvetica-font-linotype) alternative. For code blocks and snippets, [Iosevka](https://typeof.net/Iosevka) is used, where it's my go-to monospace font at this point.
...
- [Compress](https://github.com/PlayForm/Compress) is used to compress site assets and markup.
...
- [Nullboard](https://nullboard.io/changes/?have=20231105&last=20231105)
