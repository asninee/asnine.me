...
- Minimising the site's network payload as much as possible (`9kb` bundle size, [100% cleaner](https://www.websitecarbon.com/website/asnine-me) than all web pages globally).
...
- Performance: the above measures should help to guarantee quick site loading times, but there should be a habit of continally pursuing optimisations and applying them ([`100/100`](https://pagespeed.web.dev/analysis/https-asnine-me/mmmqsoimzg?form_factor=mobile) on Google's PageSpeed Insights).
